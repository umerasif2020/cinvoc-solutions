...
export default function Footer() {
 ...
 <img src={logo} width="200"  alt="logo" height="200"  style={{ marginTop: "-34px"}} />
  	 		...
  	 		<div class="footer-col">
				...
				<a href="#">	<img src={fb}  width={"35"} height={"35"}  alt="facebook" />  </a>
			<a href="#">		<img src={instagram} width={"35"} height={"35"}  alt="instagram"/> </a>
				<a href="#">		<img src={twitter} width={"35"} height={"35"}  alt="twitter" /> </a>
  	 			</div>
  	 		</div>
...
<div class="row mt-5">
    <div class="col copyright">
      <p class=""><small class="text-white-50"></small></p>
    </div>
  </div>
